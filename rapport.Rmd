...
La matrice de corrélation montre les relations linéaires entre les variables démographiques et transactionnelles. Par exemple, nous pouvons observer une corrélation négative entre l'âge du client et le total des transactions effectuées.

La corrélation entre l'âge du client et le montant total des transactions est statistiquement significative (p-value < 0.05), ce qui suggère une relation linéaire négative.
