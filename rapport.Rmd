...
```
- Il n'y a pas de données NaN dans la variable tab.
...
kable(summaries_data, "latex", booktabs = TRUE) %>%
  kable_styling(
    full_width = FALSE,
    latex_options = c("striped", "scale_down")
  ) %>%
  row_spec(0, background = "#3498db")
```
...
kable(tables_data, "latex", booktabs = TRUE) %>%
  kable_styling(
    full_width = FALSE,
    latex_options = c("striped", "scale_down")
  ) %>%
